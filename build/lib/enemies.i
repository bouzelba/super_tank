...
# 2 "source\\enemies.c" 2

# 1 "source\\/utils\\sprites.h" 1
...
struct sprite
{
 ...
 unsigned int angle;
 unsigned int scale;
 const struct vector_list_t* shape;
};



void draw_sprite(const struct sprite* s);
# 4 "source\\enemies.c" 2
